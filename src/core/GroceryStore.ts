...
export type GroceryStoreIds = 'ah' | 'aldi' | 'coop' | 'jumbo' | 'plus';
...
export interface GroceryStoreMeta {
    readonly id: GroceryStoreIds;
    readonly name: string;
    readonly endpoint: string;
    readonly additional_headers: KeyValuePairs;
    readonly default_options: GroceryStoreOptions;
}
...
export class GroceryStore {
    ...
    constructor(
        ...
        this.options.token              = options?.token            || (meta.default_options.token              || "");
        this.options.verbose            = options?.verbose          || (meta.default_options.verbose            || false);
        this.options.username           = options?.username         || (meta.default_options.username           || "");
        this.options.password           = options?.password         || (meta.default_options.password           || "");
        this.options.api_version        = options?.api_version      || (meta.default_options.api_version        || 1);
        this.options.set_api_version    = options?.set_api_version  || (meta.default_options.set_api_version    || false);
        ...
        this.client = axios.create(this.options.axios_config || (this.id == "jumbo" ? {
