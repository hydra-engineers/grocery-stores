...
export class Product extends CoopObject {
    /**
     * Get product from ID
    ...
    async getProductFromId(
        ...
        return await this.coop.get(`-;loc=nl_NL;cur=EUR/products/${productId}`, additionalRequestOptions);
    }
    ...
    async getProductsFromName(
        ...
        return await this.coop.get('-/culios/products', {
            query: {
