...
export class Store extends GroceryStore {
     ...
     */
    async getStoreFromId(storeId: number, additionalRequestOptions?: RequestOptions): Promise<StoreModel> {
        return this.client.get(`stores/${storeId}`, additionalRequestOptions);
    }
